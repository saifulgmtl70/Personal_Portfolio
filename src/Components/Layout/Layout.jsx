...
import './Layout.css';
import { FaFacebookF, FaFileAlt, FaLinkedinIn, FaUserCheck, FaGithub, FaTwitter } from "react-icons/fa";
            ...
            <section className="flex">
                <div className="hidden lg:block w-full lg:w-2/12">
                    <div className="bg-[#0E0E0E] px-4 sidemenu h-full sticky top-0 -mt-5 list-none ">
                        ...
                        <li className="-mt-[14px] mb-5">
                            <NavLink to="blog" className="flex items-center gap-[7px] py-5 px-3 transition-none text-[#fff] transition-all delay-100 font-[700]">
                                <FaBloggerB />
                ...
                <div className="w-full relative nunito_sans lg:w-10/12 h-[100vh] bg-[#1C1C1C] overflow-y-scroll">
                    <div>
                        <Outlet></Outlet>
                        <FooterNav />
                    </div>
