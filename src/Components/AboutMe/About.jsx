...
const About = () => {
    return (
        <section className="px-8 lg:px-12 py-14">
          ...
          >
                ...
                <div className="flex items-center gap-3">
                    <a href={Saifuls_resume}
                     ...
                     target="_blank"
                     rel="noreferrer">
                        <button className="px-12 py-4 rounded-[6px] bg-[#EAE112] transition-all delay-150 text-[#111] hover:bg-transparent hover:text-[#fff] hover:border border-[#EAE112]">Resume</button>
                    </a>

                    <Link to="/contact">
                        <button className="px-12 py-[14px] rounded-[6px] bg-transparent transition-all delay-150 text-[#fff] hover:bg-[#EAE112] hover:text-[#111] border border-[#EAE112]">Hire Me</button></Link>
                </div>
